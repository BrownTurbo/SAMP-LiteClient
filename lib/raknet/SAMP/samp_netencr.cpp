...
void unKyretardizeDatagram(unsigned char *buf, int len, int port, int unk)
{
	...
	/*if(bChecksum != bChecksumEncr) // TODO: Log...
		AppendLogF("[WARNING] Invalid checksum: bChecksum %d != bChecksumEncr %d", bChecksum, bChecksumEncr);*/
}
#endif
