...
{
	transport->Send(playerId, "The logger will accept user log data via the AppendLog(...) function.\r\n");
...
void LogCommandParser::WriteAppendLog(const char *channelName, const char *format, ...)
{
